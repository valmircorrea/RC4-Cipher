/**
* @file	    decifra.cpp
* @brief    Programa de decifragem usando o algoritmo RC4
...
/**
* @brief    algoritmo RC4 para decifragem
* @param    chave Chave para decifragem
* @param    msg Mensagema ser decifrada
* @param    jj posição 2
*/
...
int main (int argc, char *argv[]) {
    ...
    if (argc != 4) {
        ...
        cerr << "Use: ./decifrar chave mensagem_cifrada.txt mensagem_saida.txt" << endl;
        exit(1);
    }

    // Arquivo de saida da para msg decifrada
    string saida = argv[3];
    ...
    string texto_decifrado = RC4Cipher(chave, msg);

    // Texto escrito em arquivo
    escrita(texto_decifrado, saida);
